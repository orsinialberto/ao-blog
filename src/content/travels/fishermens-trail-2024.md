...
date: "2024-09-13"
endDate: "2024-09-24"
description: "Un cammino di 226.5 km che attraversa scogliere, spiagge e dune, offrendo panorami spettacolari lungo la costa sud-occidentale"
...
map:
  ...
  points:
    - name: "Porto Covo"
      lat: 37.8526
      lng: -8.7902
      description: "Borgo costiero famoso per le sue calette rocciose."
    - name: "Vila Nova de Milfontes"
      lat: 37.7238
      lng: -8.7828
      description: "Cittadina alla foce del fiume Mira, spiagge tranquille."
    - name: "Almograve"
      lat: 37.652687 
      lng: -8.792615
      description: "Piccolo villaggio con una lunga spiaggia selvaggia."
    - name: "Zambujeira do Mar"
      lat: 37.525
      lng: -8.7851
      description: "Scogliere panoramiche e uno dei tramonti più iconici dell'Alentejo."
    - name: "Odeceixe"
      lat: 37.4323
      lng: -8.7711
      description: "Famosa per la sua spiaggia a forma di mezzaluna sul fiume Seixe."
    - name: "Aljezur"
      lat: 37.3191
      lng: -8.8033
      description: "Antico borgo moresco dominato da un castello panoramico."
    - name: "Arrifana"
      lat: 37.321
      lng: -8.8761
      description: "Baia protetta amata da surfisti e paesaggi drammatici."
    - name: "Carrapateira"
      lat: 37.1835
      lng: -8.8944
      description: "Dune, scogliere e sentieri spettacolari verso il mare."
    - name: "Vila do Bispo"
      lat: 37.083459 
      lng: -8.912230
      description: "Piccola cittadina rurale nell'entroterra dell'Algarve."
    - name: "Sagres"
      lat: 37.0086
      lng: -8.9431
      description: "Capo ventoso e storico, vicino alla spettacolare Fortaleza."
    - name: "Salema"
      lat: 37.072
      lng: -8.951
      description: "Villaggio di pescatori con spiaggia tranquilla."
    - name: "Luz"
      lat: 37.085945
      lng: -8.730625
      description: "Località balneare con una suggestiva baia sabbiosa."
    - name: "Lagos"
      lat: 37.108550
      lng: -8.671962
      description: "Città vivace nota per le grotte e le falesie di Ponta da Piedade."
